...
<Meta title="Guides/Styling/Style Props/Interactivity" />

<DocsHeader title="Interactivity" />
...
// hardcoded
<label>
  <styled.input type="checkbox" accentColor="#3b82f6" />
</label>

// token value
<label>
  <styled.input type="checkbox" accentColor="blue.500" />
</label>
```
...
```tsx
// hardcoded
<styled.input caretColor="#3b82f6" />

// token value
<styled.input caretColor="blue.500" />
```
...
```tsx
<styled.textarea resize="both" />
<styled.textarea resize="horizontal" />
<styled.textarea resize="vertical" />
```
