...
//#region src/components/overlays/menu/recipe.ts
const itemBase = {
	textDecoration: "none",
	color: "text.main",
	userSelect: "none",
	...
	_highlighted: { bg: "interactive.tonal.neutral.0" },
	_disabled: {
		layerStyle: "disabled",
		cursor: "default"
	}
...
const menuSlotRecipe = defineSlotRecipe({
	...
	base: {
		...
		itemGroupLabel: { color: "text.muted" },
		indicator: {
			display: "inline-flex",
			alignItems: "center",
			justifyContent: "center",
