import { type HTMLChakraProps, type SystemStyleObject } from '@chakra-ui/react';
...
export declare function Grid(props: GridProps & RefAttributes<HTMLDivElement>): import("react/jsx-runtime").JSX.Element;
