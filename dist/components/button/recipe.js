...
//#region src/components/button/recipe.ts
const buttonRecipe = defineRecipe({
	...
	variants: {
		...
		*/
		compact: { true: { px: "calc({spacing.1} - 1.5px)" } },
		/**
		* If `true`, the button will have adjusted padding to align with input fields.
		*/
		inputAlignment: { true: { px: "calc({spacing.4} - 1.5px)" } }
	},
	compoundVariants: [
		{
			intent: "primary",
		...
		},
		{
			...
			css: {
				...
				color: "text.primaryInverse",
				_hover: { bg: "interactive.solid.danger.hover" },
				_active: { bg: "interactive.solid.danger.active" },
				_focusVisible: {
					bg: "interactive.solid.danger.default",
