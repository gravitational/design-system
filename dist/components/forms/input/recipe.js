...
//#region src/components/forms/input/recipe.ts
const inputRecipe = defineRecipe({
	...
	base: {
		...
		_focusVisible: {
			...
			_hover: { borderColor: "interactive.solid.primary.default" }
		},
		_readOnly: {
			cursor: "not-allowed",
			_hover: { borderColor: "interactive.tonal.neutral.2" },
			_focusVisible: { borderColor: "interactive.tonal.neutral.2" }
		},
		_disabled: {
		...
		_invalid: {
			...
			_hover: { borderColor: "interactive.solid.danger.default" }
		},
