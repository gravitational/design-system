...
//#region src/components/feedback/banner/recipe.ts
...
kind: {
		...
		danger: {
			...
			indicator: { color: "interactive.solid.danger.default" }
		},
		warning: {
			root: {
			...
			indicator: { color: "interactive.solid.alert.default" }
		},
		info: {
			root: {
			...
			indicator: { color: "interactive.solid.accent.default" }
		},
		success: {
			root: {
			...
			indicator: { color: "interactive.solid.success.default" }
		}
	} },
	defaultVariants: { kind: "danger" }
});
//#endregion
export { bannerSlotRecipe };
