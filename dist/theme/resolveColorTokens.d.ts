...
import { type ColorMode } from './resolveColorToken';
export type TokenTree = string | {
    [key: string]: TokenTree;
};
type ResolvedTokenTree<T> = T extends string ? string | undefined : T extends Record<string, any> ? {
 ...
 */
export declare function resolveColorTokens<T extends TokenTree>(system: SystemContext, tokens: T, mode: ColorMode): ResolvedTokenTree<T>;
export {};
